...
def run_command(
    ...
    planning_mode: str = typer.Option("balanced", "--planning-mode"),
    new_character_budget: int | None = typer.Option(None, "--new-character-budget", min=0),
    new_location_budget: int | None = typer.Option(None, "--new-location-budget", min=0),
    new_faction_budget: int | None = typer.Option(None, "--new-faction-budget", min=0),
    skeleton_candidates: int | None = typer.Option(None, "--skeleton-candidates", min=1),
    draft_candidates: int | None = typer.Option(None, "--draft-candidates", min=1),
